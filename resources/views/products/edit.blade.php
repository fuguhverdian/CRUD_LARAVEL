    ...
    <div class="container">
        ...
        <form action="{{route('product.update', $product->id)}}" method="POST" accept-charset="utf-8" class="justify-content-center">
            ...
            <div class="form-group">
                ...
                <input name="name" type="text" class="form-control" id="title" aria-describedby="fet1" placeholder="" value="{{$product->name}}">
                <span id="fet1" class="sr-only">Masukan nama produk yang dijual</span>
            </div>
            <div class="form-group">
                <label for="desc">Deskripsi Produk</label>
                <input name="description" type="text" class="form-control" id="desc" aria-describedby="fet2" placeholder="" value="{{$product->description}}">
